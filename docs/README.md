...
```
cp docs/_TEMPLATE-page.html  docs/<section>/<your-page>.html
```
...
```js
"my-page": {
  href: "section/my-page.html",     // relative to docs/
...
(`docs/<folder>/page.html`), so its prefixes are `../`. Deeper or
...
| `docs/a/page.html` (template) | `../../login.html` | `../assets/…` | `"../"` |
